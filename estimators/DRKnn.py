...
from sdr_toolbox.sdr_estimators.directional_regression import directional_regression


class DRKnn(BaseEstimator, RegressorMixin):
    """
    ...
    def fit(self, X, y=None):
        ...
        self.DR_space_ = directional_regression(X.T, y, d = self.n_components,
                                              n_levelsets = self.n_levelsets,
                                              rescale = self.rescale)
        self.XT_ = (self.DR_space_.T.dot(X.T)).T
    ...
    def predict(self, X, y=None):
        ...
        return self.knn_.predict(self.DR_space_.T.dot(X.T).T)
